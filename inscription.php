...
if($_POST)
{
	...
	{
		$contenu .= "<div class='erreur'>Le pseudo doit contenir entre 1 et 20 caractéres. <br> Caractére accepté : Lettre de A à Z et chiffre de 0 à 9</div>";
	}
	if(empty($contenu)) 
	{
...
<form method="post" action="" class="formeco">
    <label  for="pseudo" class="labelll">Pseudo</label><br>
    ...
    <input name="inscription" class="sinscrire" value="S'inscrire" type="submit">
</form>
